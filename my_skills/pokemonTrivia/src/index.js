...
exports.handler = function (event, context) {
    try {
     ...
     if (event.session.application.applicationId !== "amzn1.echo-sdk-ams.app.5987b947-c8e9-4fc4-a0b8-2ba12c57ea59") {
...
var ANSWER_COUNT = 4;
var GAME_LENGTH = 5;
var CARD_TITLE = "Pokemon Trivia"; // Be sure to change this for your skill.

function getWelcomeResponse(callback) {
    var sessionAttributes = {},
        speechOutput = "Pokemon Trivia. I will ask you " + GAME_LENGTH.toString()
